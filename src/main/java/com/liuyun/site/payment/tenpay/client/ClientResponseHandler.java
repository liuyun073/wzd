package com.liuyun.site.payment.tenpay.client;

import com.liuyun.site.util.tenpayUtil.MD5Util;
import com.liuyun.site.util.tenpayUtil.XMLUtil;
...
public class ClientResponseHandler {
	...
	protected boolean isTenpaySign(String[] signParameterArray) {
		...
		setDebugInfo(signPars.toString() + " => sign:" + sign + " tenpaySign:"
				+ tenpaySign);
