...
public class RdImageEngine extends ListImageCaptchaEngine {
	...
	protected void buildInitialFactories() {
		...
		RandomRangeColorGenerator cgen = new RandomRangeColorGenerator(
				...
				new int[] { 0, 100 });
		TextPaster textPaster = new RandomTextPaster(new Integer(5), new Integer(5), cgen, Boolean.valueOf(true));
		BackgroundGenerator backgroundGenerator = new UniColorBackgroundGenerator(new Integer(80), new Integer(37), Color.WHITE);
		Font[] fontsList = { new Font("Arial", 0, 12), new Font("Tahoma", 0, 12), new Font("Verdana", 0, 12) };
