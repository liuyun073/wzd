...
import com.liuyun.site.payment.hnapay;
import com.liuyun.site.payment.tenpay.TenpayRequestHandler;
import com.liuyun.site.payment.tenpay.TenpayResponseHandler;
import com.liuyun.site.payment.tenpay.client.ClientResponseHandler;
import com.liuyun.site.payment.tenpay.client.TenpayHttpClient;
...
public class PublicAction extends BaseAction {
	...
	public String baoFoopay() throws Exception {
		...
		com.liuyun.site.tool.coder.MD5 md5Obj = new com.liuyun.site.tool.coder.MD5();
