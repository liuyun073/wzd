package com.liuyun.site.bbs.api;
...
public class Test {
	public static void main(String[] args) {
		...
		String $returns = uc.uc_user_edit("zhuzhuyu", "111111", "111111", "juliezhang777@hotmail.com", 1, "", "");
	...
	public static void testLogin() {
		Client e = new Client();
		String result = e.uc_user_login("黄金玉米", "111111");
	...
	public static void testRegister() {
		...
		String $returns = uc.uc_user_register("zhuzhuyu", "111111",
				"juliezhang777@hotmail.com");
		int $uid = Integer.parseInt($returns);
		if ($uid <= 0) {
			if ($uid == -1)
				System.out.print("用户名不合法");
